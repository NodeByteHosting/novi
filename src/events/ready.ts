...
export default async (client: Client) => {
  ...
  const statuses = [
    { name: 'Watching servers go brrrrr', type: ActivityType.Custom },
    { name: 'Watching your infrastructure', type: ActivityType.Custom },
    { name: 'ping pong at lightspeed', type: ActivityType.Custom },
    { name: 'Sorting tickets like a pro', type: ActivityType.Custom },
    { name: 'Watching the matrix', type: ActivityType.Custom },
    { name: 'uptime: 99.99% (probably) 📈', type: ActivityType.Custom },
    { name: 'debugging in production', type: ActivityType.Custom },
    { name: 'Playing with fire 🔥', type: ActivityType.Custom },
    { name: 'Watching your logs', type: ActivityType.Custom },
    { name: 'nodebytestat.us', type: ActivityType.Watching },
    { name: 'Watching every request 👀', type: ActivityType.Custom },
    { name: 'RAM go brrr', type: ActivityType.Custom },
    { name: 'Skynet (but helpful)', type: ActivityType.Custom },
    { name: 'Playing with the server wires', type: ActivityType.Watching },
